...
class DetailFactory {
    static func pushIn(navigationController: UINavigationController,dependence: Dependence ,url: String) {
        
        let viewController = DetailViewController(nibName: "Detail", bundle: nil)
